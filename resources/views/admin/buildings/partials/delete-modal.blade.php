        ...
        <div class="p-6">
            ...
            <form
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <button
                        type="button"
                        class="close-delete-building flex-1 px-5 py-3 rounded-xl border border-slate-300 hover:bg-slate-100 transition">
