...
@section('title', 'Instructor Import Preview')
...
<div class="space-y-6">
        ...
        <div class="overflow-x-auto">
            ...
            <table class="min-w-full divide-y divide-slate-200">
                ...
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">Employee ID</th>
              ...
              <tr class="{{ $instructor['status'] == 'duplicate' ? 'bg-yellow-50' : ($instructor['status'] == 'invalid' ? 'bg-red-50' : '') }}">

    <td class="px-6 py-4">{{ $instructor['employee_id'] }}</td>
    ...
    <div class="flex justify-end gap-3">
        ...
        <form action="{{ route('admin.users.instructor.store') }}" method="POST">
            @csrf

            <button
                class="px-5 py-2.5 rounded-xl bg-[#0E4C6B] text-white hover:bg-[#0b3d57]">

                Import {{ $ready }} Instructors
